...
const StatCard = ({ icon: Icon, label, value, trend, trendUp, colorClass }) => (
  <div className="hover-lift bg-white dark:bg-[#1A1A1A] border border-neutral-200 dark:border-neutral-800 rounded-xl p-5 shadow-sm">
    ...
    <h3 className="text-neutral-500 dark:text-neutral-400 text-xs font-medium uppercase tracking-wider">{label}</h3>
    ...
    <div className="space-y-5">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-neutral-500 dark:text-neutral-400 text-sm mt-0.5">Real-time metrics and document processing status.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        <div className="xl:col-span-2 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link to="/extraction" className="hover-lift flex items-center p-4 bg-white dark:bg-[#1A1A1A] border border-neutral-200 dark:border-neutral-800 rounded-xl hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors group">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Process new mining documents</p>
              </div>
              <ArrowRight className="hover-lift-arrow w-5 h-5 ml-auto text-neutral-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors" />
            </Link>

            <Link to="/knowledge-base" className="hover-lift flex items-center p-4 bg-white dark:bg-[#1A1A1A] border border-neutral-200 dark:border-neutral-800 rounded-xl hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors group">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Search indexed records</p>
              </div>
              <ArrowRight className="hover-lift-arrow w-5 h-5 ml-auto text-neutral-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" />
            </Link>

            <Link to="/ai-assistant" className="hover-lift flex items-center p-4 bg-white dark:bg-[#1A1A1A] border border-neutral-200 dark:border-neutral-800 rounded-xl hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors group">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Ask questions about data</p>
              </div>
              <ArrowRight className="hover-lift-arrow w-5 h-5 ml-auto text-neutral-400 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors" />
            </Link>
          </div>
        ...
        <div className="space-y-5">
          {/* AI Insights Panel */}
          <div className="bg-gradient-to-br from-blue-700 to-indigo-800 rounded-xl p-5 shadow-sm text-white">
          ...
          <div className="bg-white dark:bg-[#1A1A1A] border border-neutral-200 dark:border-neutral-800 rounded-xl p-5 shadow-sm">
            <h2 className="text-base font-semibold text-neutral-900 dark:text-white mb-4 flex items-center gap-2">
              <Activity className="w-4 h-4 text-neutral-500" /> Activity Feed
            </h2>
            <div className="space-y-4 relative before:absolute before:inset-0 before:ml-[9px] before:-translate-x-px before:h-full before:w-[2px] before:bg-neutral-100 dark:before:bg-neutral-800">
                ...
                <div key={idx} className="relative flex items-start gap-3">
                  ...
                  <div className="flex-1 bg-neutral-50 dark:bg-[#222222] p-3 rounded-lg border border-neutral-100 dark:border-neutral-800">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-[11px] font-medium text-neutral-500">{new Date(doc.uploadedAt).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</span>
                    </div>
              ...
              {(!documents || documents.length === 0) && (
                <div className="text-[13px] text-neutral-500 text-center py-4 relative z-10">No recent activity</div>
              )}
            </div>
          </div>
        </div>
