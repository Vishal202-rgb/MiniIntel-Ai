      ...
      <div className="bg-white dark:bg-dark-card rounded-lg shadow-xl w-full max-w-md overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-4">
          <div className="mb-4">
            ...
            <input type="text" value={issue.document || (issue.documentId && (issue.documentId.filename || issue.documentId.title)) || ''} disabled className="w-full border dark:border-slate-700 rounded p-2 bg-slate-100 dark:bg-dark-bg text-gray-500" />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Field</label>
            <input type="text" value={issue.field || ''} disabled className="w-full border dark:border-slate-700 rounded p-2 bg-slate-100 dark:bg-dark-bg text-gray-500" />
          </div>
          <div className="mb-4">
