...
const AnalyticsDashboard = () => {
  ...
  if (error) {
    return (
      <div className="p-6 max-w-7xl mx-auto">
        <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50 rounded-xl p-6 flex flex-col items-center text-center">
  ...
  const kpiCards = [
    ...
    { label: 'Total Production', value: kpis.totalProduction, icon: TrendingUp, color: 'text-indigo-500', bg: 'bg-indigo-50 dark:bg-indigo-900/20' },
  ...
  const CustomTooltip = ({ active, payload, label }) => {
    if (active && payload && payload.length) {
      return (
        <div className="bg-white dark:bg-[#222222] border border-neutral-200 dark:border-neutral-700 p-3 rounded-lg shadow-lg">
    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        {kpiCards.map((stat, idx) => (
          <div key={idx} className="hover-lift bg-white dark:bg-[#1A1A1A] p-5 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex items-center gap-4 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[#1A1A1A] p-5 md:p-6 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm hover-lift">
      ...
      <div className="bg-white dark:bg-[#1A1A1A] p-5 md:p-6 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm hover-lift">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {insights.map((insight, idx) => (
            <div key={idx} className="p-4 bg-neutral-50 dark:bg-[#111111] border border-neutral-200 dark:border-neutral-800 rounded-lg group hover:border-indigo-500/50 transition-colors">
              <div className="w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-600 dark:text-indigo-400 mb-3 font-semibold text-sm">
                0{idx + 1}
              </div>
